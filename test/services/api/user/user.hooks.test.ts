...
import { buildAuthCredentialSubject, buildEmailCredentialSubject, buildFirstNameCredentialSubject, buildKYCCredentialSubject, issueCredentialsHelper } from '../../../../src/utils/credentials';
...
describe('user api service hooks version 3.0.0', () => {
  ...
  describe('helper functions', () => {
    ...
    describe('buildFirstNameCredentialSubject', () => {
      it('builds the CredentialSubject for a FirstNameCredential with the provided firstName', () => {
        const did = `did:unum:${v4}`;
        const firstName = 'test';
        const emailCredential = buildFirstNameCredentialSubject(did, firstName);
        const expected = {
